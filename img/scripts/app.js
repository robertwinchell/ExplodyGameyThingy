define(['jquery'], function($) {
    ...
    return {
	 	...
	 	init: function() {
            ...
            var gameAreaWidth = $('#grid').width();
            var gameAreaHeight = $('#grid').height();

            if(gameAreaHeight > gameAreaWidth){

                self._maxGemContainerSize = gameAreaWidth;

            } else {

                self._maxGemContainerSize = gameAreaHeight;

            }

            console.log(self._maxGemContainerSize);
